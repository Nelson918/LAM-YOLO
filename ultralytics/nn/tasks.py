...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, OBB, SPP, SPPF, Bottleneck, BottleneckCSP,
    C2f,
    C2fAttn,
    ImagePoolingAttn,
    C3Ghost,
    ...
    RepVGGDW,
    v10Detect,
    C2f_DCNv2_Dynamic, Fusion, SegNext_Attention, SPPF_LSKA, ACmix, DCNv2, C2f_DCNv2, EMA, ShuffleAttention, C2f_DWR, TripletAttention, C2f_ODConv, C2f_DynamicConv,
    C2f_GhostDynamicConv, C2f_SCConv
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    #                 args[j] = locals()[a] if a in locals() else ast.literal_eval(a)
        ...
        if m in {Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv,
            Focus, BottleneckCSP, C1, C2, C2f, RepNCSPELAN4, ADown, SPPELAN, C2fAttn, C3, C3TR, C3Ghost,
            nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, PSA, SCDown, C2fCIB,
            C2f_DCNv2_Dynamic, SPPF_LSKA, ACmix, DCNv2, C2f_DCNv2, C2f_DWR, C2f_ODConv, C2f_DynamicConv, C2f_GhostDynamicConv,
            C2f_SCConv
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            ...
            args = [c1, c2, *args[1:]]
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB, C2f_DCNv2_Dynamic, C2f_DWR,
                     C2f_ODConv, C2f_DynamicConv, C2f_GhostDynamicConv, C2f_SCConv
                     ):
        ...
        #######
        ####### attention #####
        elif m in {SegNext_Attention, EMA, ShuffleAttention, TripletAttention}:
            c2 = ch[f]
            args = [c2, *args]
        ####### attention #####
        elif m is CBLinear:
